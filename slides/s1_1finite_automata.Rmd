...
- Due at the start of class on most class meetings
- Do on looseleaf paper, so they can be scanned
...
- Drop in whenever my door is open (Winter 303).
- I promise to be there from 2-4pm MTWTh.
