...
- 1. Ryley, Sam, Tristan$^\ast$
- 3. James$^\ast$, Trevor, Drake
- 4. Wesley, Sophia$^\ast$, Carolyn
    
# Mapping Reducibility

## Whiteboard to Share for Today

[https://awwapp.com/b/uysacibe4/](https://awwapp.com/b/uysacibe4/)

```{r echo=FALSE, fig.align='center', out.width="2in"}
library(knitr)
include_graphics("images/s53Aqrcode.png", auto_pdf = TRUE)
```

On a phone,

- Use two-finger swipe to pan.
- Use two-finger pinch to zoom.
- One finger draws: be careful; everyone can draw

## {data-background="images/s53Aqrcode.png" data-background-size="contain"}
