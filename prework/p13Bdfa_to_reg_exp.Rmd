...
3. Let $A = \{0^n1^n \mid  n \in \mathbb{N}\}$. Which of the following regular expressions describe the language $A$?
$$
0^*1^*, \quad 0^+1^+, \quad 0^*011^*, \quad (01)^*, \quad (01)^+ 
$$

4. [`r paste(fnames[7:9], sep = ',')`] Suppose that $M$ is a DFA with 5 states that accepts the string \texttt{000000}.
