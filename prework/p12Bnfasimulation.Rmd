...
1. [`r paste(fnames[1:3], sep = ',')`] Apply the construction of an NFA simulator (Theorem 1.39) to obtain a DFA that is equivalent to the following NFA.
...
2. [`r paste(fnames[4:6], sep = ',')`] Determine the language recognized by the following NFA, and express your answer using the $*$ notation.
...
3. [`r paste(fnames[7:9], sep = ',')`] Apply the construction of an NFA simulator (Theorem 1.39) to obtain a DFA that is equivalent to the NFA given in Problem 2. Simplify if possible.
